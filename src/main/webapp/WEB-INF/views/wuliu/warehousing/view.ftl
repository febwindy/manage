        ...
        <div class="row">
            <div role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="productId" class="form-control" placeholder="商品编号" readonly
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="productName" class="form-control" placeholder="商品名称" readonly
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="productType" class="form-control" placeholder="商品类型" readonly
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="storeAddress" class="form-control" placeholder="存放地置" readonly
